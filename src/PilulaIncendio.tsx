...
import {IncendioIncorretaScene} from './components/IncendioIncorretaScene';
import {IncendioCorretaScene} from './components/IncendioCorretaScene';
...
import {defaultPilulaIncendioProps, type PilulaIncendioProps} from './pilulaProps';

/**
 * PilulaIncendio — 1920×1080 | 30fps | 29s (870 frames)
 *
 * Timeline:
 *   0–135   (4.5s)  IntroScene
 * 135–405   (9.0s)  IncendioIncorretaScene — situação de risco, borda vermelha
 *   ↳ 195–315       MascotSpeech hero/question
 *   ↳ 315–405       MascotSpeech hero/warning
 * 405–560   (5.2s)  IncendioCorretaScene — prevenção correta, borda verde (fadeout ~536)
 *   ↳ 420–560       MascotSpeech hero/success
 * 560–730   (5.7s)  ChecklistScene
 * 730–870   (4.7s)  ClosingFrame
 */
export const PilulaIncendio: React.FC<PilulaIncendioProps> = ({
	intro,
	speech,
	checklist,
	closing,
	...
	return (
		<AbsoluteFill style={{backgroundColor: COLORS.bg, fontFamily: FONT}}>
			...
			{/* ══ BLOCO 2 | 135-405 | Situação de RISCO ═══════════════════════ */}
			<Sequence from={135} durationInFrames={270} layout="none">
				<IncendioIncorretaScene />
			</Sequence>
			...
			{/* ══ BLOCO 3 | 405-560 | Prevenção CORRETA ═══════════════════════ */}
			<Sequence from={405} durationInFrames={155} layout="none">
				<IncendioCorretaScene totalDuration={155} />
			</Sequence>
