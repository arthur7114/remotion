...
/**
 * StairsCorretaScene — uso correto das escadas
 * Mesma estrutura da PostureCorretaScene.
 */
export const StairsCorretaScene: React.FC<{totalDuration?: number}> = ({totalDuration = 155}) => {
	...
	return (
		<AbsoluteFill style={{opacity, fontFamily: FONT}}>
			...
			<div style={{
				...
				<Img
					src={staticFile('pilula escadas - uso correto.png')}
					style={{
						width: '100%',
						height: '100%',
						objectFit: 'cover',
			...
			<svg width="1920" height="1080" viewBox="0 0 1920 1080"
				...
				<defs>
					<filter id="scCheckShadow" x="-40%" y="-40%" width="180%" height="180%">
				...
				{/* Check mark canto superior */}
				{checkProgress > 0 && (
					<g transform={`translate(${FRAME_X + FRAME_W - 80}, ${FRAME_Y - 28})`}
						opacity={checkProgress}>
						<circle cx="40" cy="40" r="38" fill={COLORS.green} filter="url(#scCheckShadow)" />
