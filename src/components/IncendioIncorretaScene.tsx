...
/**
 * IncendioIncorretaScene — situação de risco de incêndio
 * Duração: 270 frames dentro de Sequence
 */
export const IncendioIncorretaScene: React.FC = () => {
	...
	return (
		<AbsoluteFill style={{opacity: fadeIn * fadeOut, fontFamily: FONT}}>
			...
			<div style={{
				...
				<Img
					src={staticFile('incendio-incorreto.png')}
					style={{
						width: '100%',
						height: '100%',
						objectFit: 'cover',
			...
			<svg width="1920" height="1080" viewBox="0 0 1920 1080"
				...
				<defs>
					<filter id="iiAlertShadow" x="-40%" y="-40%" width="180%" height="180%">
				...
				{alertEnter > 0.05 && (
					<g transform={`translate(${FRAME_X + FRAME_W - 80}, ${FRAME_Y - 28})`}
						opacity={alertEnter}>
						<circle cx="40" cy="40" r="38" fill={COLORS.red} filter="url(#iiAlertShadow)" />
