 ...
 */
export const PostureIncorretaScene: React.FC = () => {
	...
	// Ícone de alerta entra no frame 35
	...
	return (
		<AbsoluteFill style={{opacity: opacity * fadeOut, fontFamily: FONT}}>
			...
			<div style={{
				...
				<Img
					src={staticFile('postura-incorreta.png')}
					style={{
						width: '100%',
						height: '100%',
						objectFit: 'cover',
				...
				<div style={{
					position: 'absolute',
					inset: 0,
					background: 'linear-gradient(to bottom, rgba(0,0,0,0.04) 0%, rgba(0,0,0,0.0) 40%)',
					pointerEvents: 'none',
				}} />
			</div>

			{/* Borda vermelha pulsante sobre o frame */}
			<svg width="1920" height="1080" viewBox="0 0 1920 1080"
				...
				<defs>
					<filter id="alertShadow" x="-40%" y="-40%" width="180%" height="180%">
						<feGaussianBlur stdDeviation="6" />
					</filter>
				</defs>
			</svg>

			{/* Label "POSTURA INCORRETA" — topo esquerdo do frame */}
			<div style={{
				position: 'absolute',
				left: FRAME_X + 24,
				top: FRAME_Y + 20,
